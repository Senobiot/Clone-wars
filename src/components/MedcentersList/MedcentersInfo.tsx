          ...
          <Accordion key={idx}>
            ...
            <AccordionDetails className={styles.detailsWrapped}>
              ...
              <Accordion className={styles.details}>
                ...
                <AccordionDetails>
                  <Typography className={styles.pService}>
                    {Object.values(services_category.find((elem) => elem.id === cats[0]).services)
                      .sort()
                      .map((e, idx) => {
                        if (e) {
                          return (
                            <span key={idx + 20} className={styles.spanService}>
                              &#9745; {e}
                            </span>
                          );
                        }
                ...
                <AccordionDetails>
                  <Typography className={styles.pService}>
                    {Object.values(cats[1]).map((e, idx) => {
                      ...
                      return (
                        <span key={idx + 40} className={styles.spanService}>
                          {c}: <b>{b} руб.</b>
                        </span>
                      );
                    })}
